...
var SchedulerAppointments = CollectionWidget.inherit({
    ...
    _renderAppointmentTemplate: function($container, data) {
        ...
        var startDate = dateUtils.makeDate(data.startDate),
            endDate = dateUtils.makeDate(data.endDate),
        ...
        if (allDay) {
            $("<div>").text(" " + messageLocalization.format("dxScheduler-allDay") + ": ").addClass(ALL_DAY_CONTENT_CLASS).appendTo($contentDetails)
        }
    },
